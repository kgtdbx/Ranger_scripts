...
/var/lib/ambari-server/resources/scripts/configs.sh -u admin -p admin -port 8080 set node1.openstacklocal hdptest ranger-ugsync-site  "ranger.usersync.source.impl.class" "org.apache.ranger.unixusersync.process.FileSourceUserGroupBuilder" &>/tmp/var_out1
